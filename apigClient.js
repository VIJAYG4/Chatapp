...
apigClientFactory.newClient = function (config) {
    ...
    if(config === undefined) {
        config = {
            accessKey: 'AKIAJQ7PU5KIALDWEGDQ',
            secretKey: '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',
            sessionToken: '',
            region: 'us-east-1',
            apiKey: undefined,
    ...
    var invokeUrl = 'https://4ouevp8ux3.execute-api.us-east-1.amazonaws.com/jinki';
